...
export ZEPPELIN_NOTEBOOK_DIR=/vagrant/notebook/   		# Where notebook saved
...
##
export SPARK_HOME=/home/vagrant/spark/                             # (required) When it is defined, load it instead of Zeppelin embedded Spark libraries
